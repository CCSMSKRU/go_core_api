...
function tryDo(obj, cb) {
    ...
    if (this.status === NO_AUTH) {
        if (this.debugFull)
            console.log('Еще не авторизованы. Запустим процесс и вызовем запрос снова', { obj, res: this.response });
        this.auth();
        if (!this.autoAuth)
    ...
    if (this.status === READY) {
        ...
        let res;
        let counter = 0;
        const q = () => __awaiter(this, void 0, void 0, function* () {
            try {
                res = yield this.query(obj);
                this.response = res;
                if (res.code) {
                    // Сессия стухла
                    if (res.code === -4) {
...
// @ts-ignore
let toastr = window === null || window === void 0 ? void 0 : window.toastr;
// @ts-ignore
let bootbox = window === null || window === void 0 ? void 0 : window.bootbox;
// @ts-ignore
let $ = window === null || window === void 0 ? void 0 : window.$;
class Query {
    constructor(params) {
        if (!params)
            params = {};
        ...
        this.storage = {
            get: (key) => __awaiter(this, void 0, void 0, function* () {
                if (typeof this.storeGetFn === 'function')
                    return yield this.storeGetFn(key);
                if (this.env === 'browser') {
            ...
            set: (key, val) => __awaiter(this, void 0, void 0, function* () {
                const old = yield this.storage.get(key);
                if (old === val) {
                    if (this.debugFull)
                ...
                if (typeof this.storeSetFn === 'function')
                    return yield this.storeSetFn(key, val);
                if (this.env === 'browser') {
                    if (this.browserStorage === 'cookie') {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            this.token = yield this.storage.get(this.tokenStorageKey);
            if (this.debugFull)
    ...
    query(obj = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.useAJAX
                ? yield this.queryAJAX(obj)
                : yield this.queryWS(obj);
        });
    }
    queryAJAX(obj = {}) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    connectSocket() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.socket.on("disconnect", (reason) => __awaiter(this, void 0, void 0, function* () {
                this.token = yield this.storage.get(this.tokenStorageKey);
                this.socket.auth.token = this.token;
                if (this.debug)
            ...
            // });
            // store token
            this.socket.on('token', (token) => __awaiter(this, void 0, void 0, function* () {
                if (this.debugFull)
                    console.log('onToken', new Date(), token);
                // console.log('update TOKEN')
                this.token = token;
                this.socket.auth.token = this.token;
                yield this.storage.set(this.tokenStorageKey, this.token);
            ...
            this.socket.on('socketQueryCallback', (callback_id, result, request_time) => {
                ...
                if (typeof result === 'object' && result !== null) {
                    ...
                    if (result.code !== 10) {
                        ...
                        const firstUserErrMsg = (_a = result === null || result === void 0 ? void 0 : result.data) === null || _a === void 0 ? void 0 : _a.firstUserErrMsg;
                        let r_params = item.request.params || {};
                        let show_toastr = (() => {
                            if (r_params.noToastr)
                            ...
                            if (result.code)
                                return !(r_params.noToastrError || r_params.noToastrErr);
                ...
                if (typeof item.callback === "function") {
                    ...
                    if (result !== null && typeof result == 'object') {
                        ...
                        if (item.request.isNotApi202205
                            ...
                            const resData = Object.assign({}, result.data);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.ws_status !== WS_CONNECTED) {
                ...
                return yield new Promise((resolve) => {
                    setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                        resolve(yield this.queryWS(obj));
                    }), 50);
                });
            }
            return yield new Promise((resolve, reject) => {
    ...
    auth() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let counter = 0;
            const tryQ = () => __awaiter(this, void 0, void 0, function* () {
                let authRes;
                try {
                    authRes = yield this.query(o);
                    if (this.debugFull)
                    ...
                    if (counter <= this.tryAuthCount) {
                        ...
                        authRes = yield new Promise((resolve) => {
                            setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                                resolve(yield tryQ());
                            }), this.tryAuthPause);
                        });
...
function init(params = {}) {
    const query_ = new Query(Object.assign({}, params));
    // const o2 = {
    //     command: 'get_me',
    //     object: 'User',
    //     params: {}
